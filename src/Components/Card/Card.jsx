  ...
  return (
    <div className="card bg-base-100 border-gray-300 shadow-xl  hover:scale-105 transition ease-in-out m-5 ">
      ...
      <div className="card-body space-y-3">
        <h2 className="text-2xl font-bold text-center">{ticketTitle}({transportType})</h2>
        <h2 className="text-center">From:{fromLocation} to: {toLocation}</h2>
        <h2 className=" text-center">TK {price}</h2>
            <h2 className=" text-center">Available tickets: {quantity}</h2>
      
         <p className="text-center">Departure Date : {departureDate} at {departureTime}</p>
