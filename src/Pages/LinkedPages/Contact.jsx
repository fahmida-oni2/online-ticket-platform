...
const Contact = () => (
  <div className="min-h-screen bg-white mt-2">
    <div className="bg-sky-900 text-white py-12 px-6 sm:px-10 lg:px-20">
      ...
      <div className="flex flex-wrap justify-between max-w-6xl mx-auto">
        <div className="w-full lg:w-5/12 mb-8 lg:mb-0">
          ...
          <p className="mt-2 text-gray-300 leading-relaxed whitespace-pre-line">
            Green View, 5th Floor, #No 23, Old Airport Road, Dhaka, Bangladesh -
            1200.
          </p>
        </div>
    ...
    <div className="py-12 px-6 sm:px-10 lg:px-20 max-w-7xl mx-auto">
      <h2 className="text-3xl sm:text-3xl font-bold text-center text-sky-800 mb-10">
        Other Offices
      </h2>
      ...
      <form>
        <div className="bg-base-200 max-w-6xl mx-auto  px-4 ">
          <div className="hero-content flex flex-col ">
            <div>
              <h1 className="text-4xl text-sky-800 font-bold mb-4 animate__animated animate__fadeInDown">
                Make an Enquiry
              </h1>
            </div>
            <div className=" bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
              <div className="card-body bg-blue-200 ">
                <fieldset className="fieldset">
                  <label className="label font-bold text-sky-800">Name</label>
                  <input
                    type="Name"
                    className="input"
                    placeholder="Name"
                    required
                  />
                  <label className="label font-bold text-sky-800">Email</label>
                  <input
                    type="email"
                    className="input"
                    placeholder="Email"
                    required
                  />
                  <label className="label font-bold text-sky-800">
                    Mobile No
                  </label>
                  <input
                    type="Mobile"
                    ...
                    required
                  />
                  <label className="label font-bold text-sky-800">Message</label>
                  <input type="text" className="input" placeholder="Message" />
                  <button className="btn bg-sky-800 text-white rounded-2xl hover:bg-indigo-300 mt-4">
                    Submit
                  </button>
                </fieldset>
              </div>
